...
const User = ( {loading, repos, match, getUserRepos, getUser, user } ) => {
    ...
    return (
        <Fragment>
            ...
            Hireable: {hireable ? <i className="fas fa-check text-succes"></i> : <i className="fas fa-times-circle text-danger"></i> }
